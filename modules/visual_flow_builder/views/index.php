...
<head>
    ...
    <link href="<?php echo base_url(); ?>plugins/flow_builder/js/app.6d1cd242.js" rel="preload" as="script">
...
<body>
    ...
    <script src="<?php echo base_url(); ?>plugins/flow_builder/js/app.6d1cd242.js"></script>
